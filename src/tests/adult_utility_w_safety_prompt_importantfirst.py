...
if __name__ == '__main__':
    ...
    app_agent = agent(model_name=model_name, max_new_tokens = 50, predefenses = [], postdefenses = [], fetch_probs=False, context_data = '/bigtemp/duh6ae/LLM_App_Privacy/local_data/adult_importantfirst')
