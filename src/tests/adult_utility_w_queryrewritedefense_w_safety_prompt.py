...
if __name__ == '__main__':
    set_seed(42)
    filename = 'adult_utility_w_queryrewritedefense_w_safety_prompt'
    model_name = "allenai/tulu-2-dpo-7b" #"allenai/tulu-v2.5-dpo-13b-uf-mean"
    fetch_probs=True
    app_agent = agent(model_name=model_name, max_new_tokens = 50, predefenses = ['query_rewriter'], postdefenses = [], fetch_probs=fetch_probs, context_data = '/bigtemp/duh6ae/LLM_App_Privacy/local_data/adult_dimreduced')
